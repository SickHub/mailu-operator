...
OPERATOR_SDK_VERSION ?= v1.37.0 # github-releases:operator-framework/operator-sdk
# Image URL to use all building/pushing image targets
IMG ?= drpsychick/mailu-operator:$(VERSION)
# ENVTEST_K8S_VERSION refers to the version of kubebuilder assets to be downloaded by envtest binary.
ENVTEST_K8S_VERSION = 1.31.2 # github-releases:kubernetes/kubernetes
...
CONTROLLER_TOOLS_VERSION ?= v0.16.4 # github-releases:kubernetes-sigs/controller-tools
