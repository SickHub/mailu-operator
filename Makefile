...
ENVTEST_K8S_VERSION = 1.37.0 # github-releases:kubernetes-sigs/controller-tools:envtest-v(?<version>.*)
...
CONTROLLER_TOOLS_VERSION ?= v0.22.0 # github-releases:kubernetes-sigs/controller-tools
ENVTEST_VERSION ?= release-0.19 # github-releases:kubernetes-sigs/controller-runtime
GOLANGCI_LINT_VERSION ?= v2.13.2 # github-releases:golangci/golangci-lint
